...
const EditLicenciaModal = ({ open, onClose, onEdit, licencia }) => {
  const [form, setForm] = useState(licencia || {
    equipo: "",
    software: "",
    licencia: ""
  });
  ...
  React.useEffect(() => {
    setForm(licencia || { equipo: "", software: "", licencia: "" });
  }, [licencia]);
    ...
    <div className="modal-overlay" style={{zIndex:9999}}>
      <div className="modal-content modal-animate" style={{minWidth:360, maxWidth:420, padding:'2.5rem 2.5rem', background:'#181818', border:'2.5px solid #ffe600', borderRadius:18, boxShadow:'0 8px 32px rgba(0,0,0,0.45)'}}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.7rem', marginBottom: '1.8rem', justifyContent: 'flex-start' }}>
          ...
          <span style={{ fontWeight: 700, color: '#ffd600', fontSize: '1.35rem', letterSpacing: 0.5 }}>Editar licencia</span>
        </div>
        <form onSubmit={handleSubmit} className="edit-licencia-form">
